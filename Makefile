...
otelcol-unstable:
	GO111MODULE=on CGO_ENABLED=0 $(GOCMD) build -trimpath -o ./bin/otelcol_unstable_$(GOOS)_$(GOARCH)$(EXTENSION) \
		$(BUILD_INFO) -tags $(GO_BUILD_TAGS),enable_unstable ./cmd/otelcol

.PHONY: otelcol-all-sys
otelcol-all-sys: otelcol-darwin_amd64 otelcol-darwin_arm64 otelcol-linux_amd64 otelcol-linux_arm64 otelcol-windows_amd64

.PHONY: otelcol-darwin_amd64
otelcol-darwin_amd64:
	GOOS=darwin  GOARCH=amd64 $(MAKE) otelcol

.PHONY: otelcol-darwin_arm64
otelcol-darwin_arm64:
	GOOS=darwin  GOARCH=arm64 $(MAKE) otelcol

.PHONY: otelcol-linux_amd64
otelcol-linux_amd64:
	GOOS=linux   GOARCH=amd64 $(MAKE) otelcol

.PHONY: otelcol-linux_arm64
otelcol-linux_arm64:
	GOOS=linux   GOARCH=arm64 $(MAKE) otelcol

.PHONY: otelcol-windows_amd64
otelcol-windows_amd64:
